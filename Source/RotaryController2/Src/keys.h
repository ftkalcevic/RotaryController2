...
public:
	enum KeyCodes
	{
		...
		KEY_NUM_8_PRESSED	= KEY_NUM_8	| KEY_PRESSED,
		KEY_M100_PRESSED	= KEY_M100	| KEY_PRESSED,
		KEY_NUM_9_PRESSED	= KEY_NUM_9	| KEY_PRESSED,
		KEY_M10_PRESSED		= KEY_M10	| KEY_PRESSED,
		KEY_LEFT_PRESSED	= KEY_LEFT	| KEY_PRESSED,
		KEY_M1_PRESSED		= KEY_M1	| KEY_PRESSED,
		KEY_PREV_PRESSED	= KEY_PREV	| KEY_PRESSED,
		KEY_NUM_4_PRESSED	= KEY_NUM_4	| KEY_PRESSED,
		KEY_P1000_PRESSED	= KEY_P1000	| KEY_PRESSED,
		KEY_NUM_5_PRESSED	= KEY_NUM_5	| KEY_PRESSED,
		KEY_P100_PRESSED	= KEY_P100	| KEY_PRESSED,
		KEY_NUM_6_PRESSED	= KEY_NUM_6	| KEY_PRESSED,
		KEY_P10_PRESSED		= KEY_P10	| KEY_PRESSED,
		KEY_RIGHT_PRESSED	= KEY_RIGHT	| KEY_PRESSED,
		KEY_P1_PRESSED		= KEY_P1	| KEY_PRESSED,
		KEY_NEXT_PRESSED	= KEY_NEXT	| KEY_PRESSED,
		KEY_NUM_1_PRESSED	= KEY_NUM_1	| KEY_PRESSED,
		KEY_NUM_2_PRESSED	= KEY_NUM_2	| KEY_PRESSED,
		KEY_NUM_3_PRESSED	= KEY_NUM_3	| KEY_PRESSED,
		KEY_SPEED_PRESSED	= KEY_SPEED	| KEY_PRESSED,
		KEY_MODE_PRESSED	= KEY_MODE	| KEY_PRESSED,
		KEY_GOTO_PRESSED	= KEY_GOTO	| KEY_PRESSED,
		KEY_NUM_0_PRESSED	= KEY_NUM_0	| KEY_PRESSED,
		KEY_ZERO_PRESSED	= KEY_ZERO	| KEY_PRESSED,
		KEY_DECIMAL_PRESSED	= KEY_DECIMAL	| KEY_PRESSED,
		KEY_UNITS_PRESSED	= KEY_UNITS	| KEY_PRESSED,
